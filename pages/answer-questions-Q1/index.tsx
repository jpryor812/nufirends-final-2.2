  ...
  return (
    <div className={styles.answerQuestionsQ1}>
      <div className={styles.nufriendsHeaderFrame}>
        ...
        <img className={styles.robotHeaderImageIcon} alt="Robot Header" src="/robot-header-image.svg" />
      </div>

      {/* Commenting out the unnecessary divs */}
      ...
      <div className={styles.answerQuestionsQ1Inner}>
        <div className={styles.groupWrapper}>
          <div className={styles.rectangleParent}>
            ...
            <img className={styles.micIcon} alt="Mic" src="mic.svg" />
